...
public class ForgedPickaxeItem extends PickaxeItem {
    ...
    public ForgedPickaxeItem(Material material) {
        super(ForgedToolHelper.vanillaTier(material), new Properties()
            .durability(material.durability())
            .attributes(PickaxeItem.createAttributes(ForgedToolHelper.vanillaTier(material),
                material.baseDamage() + ForgedToolHelper.kindDamageBonus("pickaxe")
                    - ForgedToolHelper.vanillaTier(material).getAttackDamageBonus(),
                ForgedToolHelper.baseAttackSpeed("pickaxe"))));
