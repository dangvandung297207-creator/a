...
/**
 * Voxel-faithful Ender Blade geometry converted from the Three.js preview.
 * Units: 1 block = 16 texels. Blade extends +Y from grip pivot.
 *
 * Separated parts: blade, blade_edge, void_cracks, guard, handle,
 * pommel, ender_core, runes, emissive.
 */
public class EnderBladeModel extends Model {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        // ---- Blade body (stacked voxels, tip at high Y) ----
    ...
    /** Idle animation: rotate ender core. */
